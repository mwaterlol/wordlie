...
export function jsNormalizedLang(lang) {
    return lang.replace(/-/, '_');
}
export function enumerateLangs(dir) {
    return fs.readdirSync(dir).filter(function (file) {
        return fs.statSync(path.join(dir, file)).isDirectory();
    });
}
export function resolvePaths(paths, cwd) {
...
export function assertExistence(paths) {
...
export function loadAndParse(langFile) {
